...
import { Plus, Receipt, Calendar, AlertTriangle, Upload, Search, TrendingUp } from 'lucide-react'
          ...
          >
            ...
            <div className="p-phi-xl">
              ...
              <div className="flex gap-phi mt-phi-lg justify-center">
                ...
                <button 
                  className="btn-phi-md font-medium hover-lift transition-all duration-200"
                  style={{
                    background: 'linear-gradient(135deg, var(--color-accent-500), var(--color-accent-600))',
                    color: 'white',
                    boxShadow: '0 4px 16px rgba(59, 130, 246, 0.3)',
